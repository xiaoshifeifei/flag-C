	...
	<view class="rf-index">
		...
		>
			<block v-if="currentCate === 0">
				...
				<!-- <view class="padding"> -->
				<view
					class="padding nav fixed bg-white home-nav text-center"
					style="margin: 0"
				>
					<u-search
						input-align="center"
...
import { bannerList, indexConfig, productList, falgdes } from '@/api/basic';
