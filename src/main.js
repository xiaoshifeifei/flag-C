...
import $mflagShare from '@/utils/flagShare';
// 全局组件
...
import flagShare from '@/components/flag-share';
import flagSend from '@/components/flag-send';
import flagComment from '@/components/flag-comment';
import {
    getAppUpdate
} from "./utils/appUpdate"

import './pages/getPrize/directive';
//#ifdef H5
...
Vue.prototype.$mflagShare = $mflagShare;
...
Vue.component('rfNoData', rfNoData);
Vue.component('flagShare', flagShare);
Vue.component('flagSend', flagSend);
Vue.component('flagComment', flagComment);
